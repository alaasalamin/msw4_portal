                ...
                <form onSubmit={submit} className="space-y-4">
                    <div>
                        ...
                        <input
                            ...
                            className={`block w-full rounded-xl border bg-zinc-700/50 px-4 py-3 text-sm text-white placeholder-zinc-500 transition focus:outline-none focus:ring-2 focus:ring-orange-500 ${
                                errors.email ? 'border-rose-500' : 'border-white/8'
                            }`}
                    ...
                    <div>
                        ...
                        <div className="relative">
                            <input
                                ...
                                className={`block w-full rounded-xl border bg-zinc-700/50 px-4 py-3 pr-11 text-sm text-white placeholder-zinc-500 transition focus:outline-none focus:ring-2 focus:ring-orange-500 ${
                                    errors.password ? 'border-rose-500' : 'border-white/8'
                                }`}
                                placeholder="••••••••"
                            />
                            <button
