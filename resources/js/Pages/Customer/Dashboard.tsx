    ...
    return (
        <div className="min-h-screen bg-zinc-900 text-white">
            ...
            <main className="mx-auto max-w-7xl px-4 py-10 sm:px-6 lg:px-8">
                <div className="mb-8">
                    <h1 className="font-display text-2xl font-normal text-white">Willkommen im Kundenportal</h1>
                    <p className="mt-1 text-sm text-zinc-400">Verfolgen Sie Ihre Reparaturen und verwalten Sie Ihre Geräte.</p>
                </div>
                    ...
                    {[
                        {
                            ...
                            desc: 'Sendungen verfolgen und Reparaturstatus einsehen',
                            icon: (
                        ...
                        },
                        {
                            ...
                            desc: 'Neuen Reparaturauftrag erstellen und Gerät einsenden',
                            icon: (
                                <svg className="h-5 w-5 text-orange-400" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
