                            ...
                            <div className="mt-6 flex flex-wrap gap-3">
                                {socialEntries.map(([platform, url]) => (
                                    <a
                                        ...
                                        aria-label={platform}
                                        className="flex h-9 w-9 items-center justify-center rounded-lg border border-white/10 text-zinc-400 transition hover:border-orange-500/40 hover:text-orange-400"
                                    >
                    ...
                    {footer_pages.length > 0 && (
                        <div>
                            ...
                            <ul className="space-y-2 text-sm text-zinc-500">
                                {footer_pages.map((p) => (
                                    <li key={p.href}>
                                        <Link href={p.href} className="transition hover:text-zinc-300">{p.title}</Link>
                                    </li>
                                ))}
                            </ul>
                        </div>
                                        ...
                                        <ul className="space-y-1.5 text-sm text-zinc-500">
                                            {cat.posts.map((post) => (
                                                <li key={post.href} className="flex items-start gap-1.5">
                                                    ...
                                                    <Link href={post.href} className="leading-snug transition hover:text-zinc-300">
                                                        {post.title}
                                                    </Link>
                                                </li>
                                            ))}
