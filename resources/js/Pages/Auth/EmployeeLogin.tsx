...
export default function EmployeeLogin({ status }: EmployeeLoginProps) {
    ...
    return (
        <div className="relative flex min-h-screen flex-col items-center justify-center overflow-hidden bg-zinc-900 px-4 py-12">
            ...
            {/* Background */}
            <div className="pointer-events-none absolute -top-40 left-1/2 h-[500px] w-[500px] -translate-x-1/2 rounded-full bg-violet-600/8 blur-3xl" />
            ...
            <div className="relative mb-8">
                <Link href="/" className="flex items-center gap-2.5 focus:outline-none focus-visible:ring-2 focus-visible:ring-violet-400 rounded-md">
                    <span className="flex h-10 w-10 items-center justify-center rounded-xl bg-violet-600 shadow-lg shadow-violet-600/30">
            ...
            <div className="relative w-full max-w-sm">
                <div className="rounded-2xl border border-white/8 bg-white/5 p-8 shadow-2xl backdrop-blur-xl">
                    ...
                    <div className="mb-6 flex items-center gap-2">
                        <IconLock />
                        <span className="text-sm font-medium text-violet-300">Staff Access Only</span>
                    </div>
                    ...
                    <form onSubmit={submit} className="space-y-4">
                        ...
                        <div>
                            ...
                            <input
                                ...
                                className={`block w-full rounded-lg border bg-white/10 px-3.5 py-2.5 text-sm text-white placeholder-zinc-500 transition focus:outline-none focus:ring-2 focus:ring-violet-500 ${
                        ...
                        <div>
                            ...
                            <div className="relative">
                                <input
                                    ...
                                    placeholder="••••••••"
                                    className={`block w-full rounded-lg border bg-white/10 px-3.5 py-2.5 pr-11 text-sm text-white placeholder-zinc-500 transition focus:outline-none focus:ring-2 focus:ring-violet-500 ${
                        ...
                        <label className="flex cursor-pointer items-center gap-2 text-sm text-zinc-400">
                            <input
                                ...
                                className="h-4 w-4 rounded border-white/20 bg-white/10 text-violet-500 focus:ring-violet-500 focus:ring-offset-0 focus:ring-offset-transparent"
                            />
                        ...
                        <button
                            type="submit"
                            disabled={processing}
                            className="flex w-full cursor-pointer items-center justify-center gap-2 rounded-lg bg-violet-600 px-4 py-2.5 text-sm font-semibold text-white transition hover:bg-violet-500 active:scale-[0.98] focus:outline-none focus-visible:ring-2 focus-visible:ring-violet-400 focus-visible:ring-offset-2 focus-visible:ring-offset-zinc-900 disabled:opacity-60"
                        >
                            {processing ? (
