    ...
    <div className="flex items-center gap-2.5">
        <span className="flex h-8 w-8 items-center justify-center rounded-lg bg-violet-600">
            <svg className="h-4 w-4 text-white" viewBox="0 0 32 32" fill="none">
                ...
                <circle cx="18.5" cy="12.5" r="7" fill="#7C3AED" />
            </svg>
        </span>
        <span className="font-display text-xl font-normal text-white">
            Moon<span className="text-violet-400">repair</span>
        </span>
    </div>
);

const IconCheck = () => (
    <svg className="h-4 w-4 shrink-0 text-violet-400" fill="none" viewBox="0 0 24 24" strokeWidth={2.5} stroke="currentColor">
    ...
    <div>
        ...
        <div className="relative">
            <input
                ...
                className={`block w-full rounded-lg border px-3.5 py-2.5 text-sm text-zinc-900 placeholder-zinc-400 transition focus:outline-none focus:ring-2 focus:ring-violet-500 focus:border-violet-500 ${
    ...
    return (
        <form onSubmit={submit} className="space-y-4">
            ...
            <div className="flex items-center justify-between">
                ...
                {canResetPassword && (
                    <Link
                        ...
                        className="text-sm text-violet-600 hover:text-violet-700 focus:outline-none focus-visible:underline"
                    >
                        Forgot password?
                    </Link>
                )}
            ...
            <button
                type="submit"
                disabled={processing}
                className="flex w-full cursor-pointer items-center justify-center gap-2 rounded-lg bg-violet-600 px-4 py-2.5 text-sm font-semibold text-white transition hover:bg-violet-700 active:scale-[0.98] focus:outline-none focus-visible:ring-2 focus-visible:ring-violet-500 focus-visible:ring-offset-2 disabled:opacity-60"
            >
                {processing ? (
    ...
    return (
        <div className="flex min-h-screen">
            ...
            <div className="relative hidden w-[45%] flex-col justify-between overflow-hidden bg-zinc-900 p-10 lg:flex">
                {/* Background blobs */}
                <div className="pointer-events-none absolute -top-32 -left-32 h-96 w-96 rounded-full bg-violet-600/10 blur-3xl" />
                <div className="pointer-events-none absolute -bottom-32 -right-10 h-80 w-80 rounded-full bg-violet-600/8 blur-3xl" />
                {/* Grid overlay */}
                <div
                ...
                <div className="relative">
                    <Link href="/" className="focus:outline-none focus-visible:ring-2 focus-visible:ring-violet-400 rounded-md inline-block">
                        <MoonLogo />
                    </Link>
                </div>
                ...
                <div className="w-full max-w-md">
                    ...
                    <div className="rounded-2xl border border-zinc-200 bg-white p-8 shadow-sm">
                        ...
                        <div className="flex rounded-xl bg-zinc-100 p-1 mb-6">
                            <button
                                ...
                                className={`flex-1 cursor-pointer rounded-lg px-4 py-2 text-sm font-medium transition-all duration-150 focus:outline-none focus-visible:ring-2 focus-visible:ring-violet-500 ${
                                    tab === 'login'
                    ...
                    <p className="mt-6 text-center text-sm text-zinc-500">
                        ...
                        <Link
                            ...
                            className="font-medium text-violet-600 hover:text-violet-700 focus:outline-none focus-visible:underline"
                        >
