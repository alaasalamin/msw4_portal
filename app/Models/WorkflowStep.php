...
{
    protected $fillable = ['phase_id', 'label', 'sort_order', 'custom_fields', 'email_template_ids'];

    protected $casts = ['sort_order' => 'integer', 'custom_fields' => 'array', 'email_template_ids' => 'array'];
